...
sys.path.append('D:\Dokumente\JKU\Masterarbeit\benchmark\mimic3-benchmarks-master')
...
normalizer.load_params('decomp_ts{}.input_str_previous.n1e5.start_time_zero.normalizer'.format(args.timestep))
